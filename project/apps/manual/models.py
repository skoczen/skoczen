...
class GutterBumper(BaseModel):
    ...
    find_myself_morning = models.TextField(blank=True, null=True)
    one_thing_done = models.TextField(blank=True, null=True)
    one_thing_done_finished = models.BooleanField(default=False)
