...
class GutterBumperAdmin(ImportExportModelAdmin):
    ...
    list_display = ("date", "sleep_hrs","work_hrs","alone_hrs","friend_hrs","relationship_hrs","public_hrs","off","worked_out","meditated","number_of_fun_beers","number_of_sleep_beers","presence","happiness","creativity","morning_mood", "unbusy", "burnt_out",)
    list_filter = ("date",)
