...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.spoons_set'
        db.add_column(u'manual_gutterbumper', 'spoons_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.spoons_set'
        db.delete_column(u'manual_gutterbumper', 'spoons_set')
