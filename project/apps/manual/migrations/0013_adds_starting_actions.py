...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Action.objects.get_or_create(name="Did feldenkrais")
        orm.Action.objects.get_or_create(name="Did parcour")
        orm.Action.objects.get_or_create(name="Did started a new project")
        orm.Action.objects.get_or_create(name="Worked on an existing project")
        orm.Action.objects.get_or_create(name="Volunteered")
        orm.Action.objects.get_or_create(name="Exposed to new ideas")
        orm.Action.objects.get_or_create(name="Did lumosity")
        orm.Action.objects.get_or_create(name="Read news/NYT")
        orm.Action.objects.get_or_create(name="Exposed to non-fluent language")
        orm.Action.objects.get_or_create(name="Learned a new thing")
        orm.Action.objects.get_or_create(name="Took a heart-raising risk")
        orm.Action.objects.get_or_create(name="BBQ'd")
        t = orm.Action.objects.get_or_create(name="Travelled")[0]

        for b in orm.GutterBumper.objects.all():
            if b.travelling_or_out_of_routine:
                print "Travelling on %s" % b.date
                b.actions.add(t)
                b.save()

    def backwards(self, orm):
        orm.Action.objects.all().delete()
    ...
    models = {
        ...
        u'manual.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
        ...
        u'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
        ...
        u'manual.weight': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'})
        },
        u'manual.workout': {
