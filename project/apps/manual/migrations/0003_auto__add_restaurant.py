...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('manual_restaurant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('meal', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('have_gone', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_went', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('manual', ['Restaurant'])


    def backwards(self, orm):
        
        # Deleting model 'Restaurant'
        db.delete_table('manual_restaurant')
