...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.find_myself_morning'
        db.add_column(u'manual_gutterbumper', 'find_myself_morning',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GutterBumper.one_thing_done'
        db.add_column(u'manual_gutterbumper', 'one_thing_done',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GutterBumper.one_thing_done_finished'
        db.add_column(u'manual_gutterbumper', 'one_thing_done_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.find_myself_morning'
        db.delete_column(u'manual_gutterbumper', 'find_myself_morning')

        # Deleting field 'GutterBumper.one_thing_done'
        db.delete_column(u'manual_gutterbumper', 'one_thing_done')

        # Deleting field 'GutterBumper.one_thing_done_finished'
        db.delete_column(u'manual_gutterbumper', 'one_thing_done_finished')
    ...
    models = {
        ...
        u'manual.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 14, 0, 0)'}),
            'emotions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['manual.Emotion']", 'null': 'True', 'blank': 'True'}),
            'experienced_depression': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'fell_asleep_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 0)'}),
            'find_myself_morning': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'one_thing_done': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'one_thing_done_finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'spoons': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'spoons_set': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'manual.monthlycheckin': {
            ...
            'how_i_feel_in_my_body_notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'how_i_feel_in_my_body_rating': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 14, 0, 0)'}),
        ...
        u'manual.weight': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 2, 14, 0, 0)'})
        },
        u'manual.workout': {
