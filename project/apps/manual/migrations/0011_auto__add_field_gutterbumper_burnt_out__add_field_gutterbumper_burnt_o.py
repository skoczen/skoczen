...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.burnt_out'
        db.add_column(u'manual_gutterbumper', 'burnt_out',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GutterBumper.burnt_out_set'
        db.add_column(u'manual_gutterbumper', 'burnt_out_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.burnt_out'
        db.delete_column(u'manual_gutterbumper', 'burnt_out')

        # Deleting field 'GutterBumper.burnt_out_set'
        db.delete_column(u'manual_gutterbumper', 'burnt_out_set')
