...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Action'
        db.create_table(u'manual_action', (
        ...
        db.send_create_signal(u'manual', ['Action'])

        # Adding M2M table for field actions on 'GutterBumper'
        m2m_table_name = db.shorten_name(u'manual_gutterbumper_actions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gutterbumper', models.ForeignKey(orm[u'manual.gutterbumper'], null=False)),
            ('action', models.ForeignKey(orm[u'manual.action'], null=False))
        ))
        db.create_unique(m2m_table_name, ['gutterbumper_id', 'action_id'])


    def backwards(self, orm):
        # Deleting model 'Action'
        db.delete_table(u'manual_action')

        # Removing M2M table for field actions on 'GutterBumper'
        db.delete_table(db.shorten_name(u'manual_gutterbumper_actions'))
