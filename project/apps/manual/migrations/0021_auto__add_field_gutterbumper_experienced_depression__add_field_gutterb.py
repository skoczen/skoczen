...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.experienced_depression'
        db.add_column(u'manual_gutterbumper', 'experienced_depression',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GutterBumper.spoons'
        db.add_column(u'manual_gutterbumper', 'spoons',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.experienced_depression'
        db.delete_column(u'manual_gutterbumper', 'experienced_depression')

        # Deleting field 'GutterBumper.spoons'
        db.delete_column(u'manual_gutterbumper', 'spoons')
    ...
    models = {
        ...
        u'manual.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 13, 0, 0)'}),
        ...
        u'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 13, 0, 0)'}),
        ...
        u'manual.weight': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 2, 13, 0, 0)'})
        },
        u'manual.workout': {
