...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeeklyGoal'
        db.create_table(u'manual_weeklygoal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('primary', self.gf('django.db.models.fields.CharField')(max_length=210)),
            ('secondary', self.gf('django.db.models.fields.CharField')(max_length=210)),
            ('tertiary', self.gf('django.db.models.fields.CharField')(max_length=210)),
        ))
        db.send_create_signal(u'manual', ['WeeklyGoal'])


    def backwards(self, orm):
        # Deleting model 'WeeklyGoal'
        db.delete_table(u'manual_weeklygoal')
    ...
    models = {
        ...
        u'manual.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
        ...
        u'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
        ...
        u'manual.weight': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'})
        },
        u'manual.workout': {
