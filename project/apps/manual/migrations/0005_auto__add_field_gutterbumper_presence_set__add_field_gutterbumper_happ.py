...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GutterBumper.presence_set'
        db.add_column('manual_gutterbumper', 'presence_set', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'GutterBumper.happiness_set'
        db.add_column('manual_gutterbumper', 'happiness_set', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'GutterBumper.creativity_set'
        db.add_column('manual_gutterbumper', 'creativity_set', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'GutterBumper.morning_mood_set'
        db.add_column('manual_gutterbumper', 'morning_mood_set', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GutterBumper.presence_set'
        db.delete_column('manual_gutterbumper', 'presence_set')

        # Deleting field 'GutterBumper.happiness_set'
        db.delete_column('manual_gutterbumper', 'happiness_set')

        # Deleting field 'GutterBumper.creativity_set'
        db.delete_column('manual_gutterbumper', 'creativity_set')

        # Deleting field 'GutterBumper.morning_mood_set'
        db.delete_column('manual_gutterbumper', 'morning_mood_set')
    ...
    models = {
        ...
        'manual.gutterbumper': {
            ...
            'creativity_set': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 15)'}),
            ...
            'happiness_set': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'morning_mood_set': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'presence_set': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 15)'}),
