...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.neap_hrs'
        db.add_column(u'manual_gutterbumper', 'neap_hrs',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GutterBumper.ate_green'
        db.add_column(u'manual_gutterbumper', 'ate_green',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.neap_hrs'
        db.delete_column(u'manual_gutterbumper', 'neap_hrs')

        # Deleting field 'GutterBumper.ate_green'
        db.delete_column(u'manual_gutterbumper', 'ate_green')
    ...
    models = {
        ...
        u'manual.gutterbumper': {
            ...
            'ate_green': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 15, 0, 0)'}),
            ...
            'neap_hrs': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 2, 15, 0, 0)'}),
        ...
        u'manual.weight': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 2, 15, 0, 0)'})
        },
        u'manual.workout': {
