...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.WeeklyGoal.objects.get_or_create(
            start_date=datetime.date(year=2014, month=7, day=6),
            primary="GreenKahuna",
            secondary="Write Around Portland",
            tertiary="Life Plan",
        )
        orm.WeeklyGoal.objects.get_or_create(
            start_date=datetime.date(year=2014, month=7, day=13),
            primary="GreenKahuna",
            secondary="Write Around Portland",
            tertiary="Life Plan",
        )
    ...
    def backwards(self, orm):
        orm.WeeklyGoal.objects.all().delete()
