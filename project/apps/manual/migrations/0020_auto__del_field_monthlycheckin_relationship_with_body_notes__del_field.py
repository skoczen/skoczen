...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MonthlyCheckin.how_i_feel_in_my_body_rating'
        db.add_column(u'manual_monthlycheckin', 'how_i_feel_in_my_body_rating',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MonthlyCheckin.how_i_feel_in_my_body_notes'
        db.add_column(u'manual_monthlycheckin', 'how_i_feel_in_my_body_notes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MonthlyCheckin.how_i_feel_in_my_body_rating'
        db.delete_column(u'manual_monthlycheckin', 'how_i_feel_in_my_body_rating')

        # Deleting field 'MonthlyCheckin.how_i_feel_in_my_body_notes'
        db.delete_column(u'manual_monthlycheckin', 'how_i_feel_in_my_body_notes')
