...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.moon_phase'
        db.add_column(u'manual_gutterbumper', 'moon_phase',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.moon_phase'
        db.delete_column(u'manual_gutterbumper', 'moon_phase')
