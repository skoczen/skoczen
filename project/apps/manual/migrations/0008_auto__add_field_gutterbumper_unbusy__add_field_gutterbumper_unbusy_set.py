...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GutterBumper.unbusy'
        db.add_column('manual_gutterbumper', 'unbusy', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'GutterBumper.unbusy_set'
        db.add_column('manual_gutterbumper', 'unbusy_set', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GutterBumper.unbusy'
        db.delete_column('manual_gutterbumper', 'unbusy')

        # Deleting field 'GutterBumper.unbusy_set'
        db.delete_column('manual_gutterbumper', 'unbusy_set')
    ...
    models = {
        ...
        'manual.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 5, 8)'}),
            ...
            'woke_up_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(5, 45)'}),
        ...
        'manual.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 5, 8)'}),
