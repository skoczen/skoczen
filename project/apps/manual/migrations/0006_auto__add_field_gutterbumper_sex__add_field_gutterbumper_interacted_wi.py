...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GutterBumper.sex'
        db.add_column('manual_gutterbumper', 'sex', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'GutterBumper.interacted_with_art'
        db.add_column('manual_gutterbumper', 'interacted_with_art', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GutterBumper.sex'
        db.delete_column('manual_gutterbumper', 'sex')

        # Deleting field 'GutterBumper.interacted_with_art'
        db.delete_column('manual_gutterbumper', 'interacted_with_art')
