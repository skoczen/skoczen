...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hike.am_back'
        db.delete_column('hiking_hike', 'am_back')

        # Adding field 'Hike.is_back'
        db.add_column('hiking_hike', 'is_back',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Hike.am_back'
        db.add_column('hiking_hike', 'am_back',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Hike.is_back'
        db.delete_column('hiking_hike', 'is_back')
