...
, "off", "worked_out", "meditated", "left_the_house", "travelling_or_out_of_routine", "nature_time", "number_of_sleep_beers","number_of_fun_beers", "spoons", "presence", "happiness", "creativity", "morning_mood", "notes"
    , "emotions", "actions", )
